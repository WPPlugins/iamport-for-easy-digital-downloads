...
class EddIamportSubscription extends EddIamportBase {
	...
	public function process_payment($purchase_data) {
		...
		if( !$errors ) {
			...
			if ( !empty($_POST['iamport_subscription_remember']) ) {
	...
	public function cc_form() {
		...
		<fieldset id="edd-iamport-subscription-rsa" data-module="<?=$public_key['module']?>" data-exponent="<?=$public_key['exponent']?>">
			...
			<p>
				...
				<input type="text" autocomplete="off" name="iamport_subscription_card_number" class="card-name edd-input required" placeholder="1234123412341234" maxlength="16"/>
			</p>
	...
	private function get_customer_uid($unique_key) {
